...
(defun pasm-to-file (prototype-symbol infilename outfilename)
  (let ((scanned-pasm (scanner:scanner (alexandria:read-file-into-string infilename))))
    (let ((p (make-instance 'parser)))
      ...
      (<pasm> p)
      (let ((pkg (package-name (find-package (symbol-package prototype-symbol)))))
